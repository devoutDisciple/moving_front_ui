    ...
    render() {
        ...
        return (
            <TouchableOpacity
                style={
                    active
                        ? styles.content_account_chunk_active
                        : styles.content_account_chunk
                }
                onPress={onPress}>
                <Text style={styles.content_account_chunk_top_text}>
                    充{money}元
                </Text>
                {discount && (
                    <Text style={styles.content_account_chunk_bottom_text}>
                        送{discount}元
                    </Text>
                )}
            </TouchableOpacity>
