                    ...
                    {addressList.map((item, index) => {
                        return (
                            <View key={index} style={styles.content_item}>
                                <TouchableOpacity
                                    onPress={this.selectRadio.bind(this, index)}
                                    style={styles.content_item_left}>
                                    <Image
                                ...
                                <View style={styles.content_item_center}>
                                    <View
                                        style={
                                            styles.content_item_center_title
                                        }>
                                        <Text
                                            style={
                                                styles.content_item_center_title_text
                                            }>
                                            {item.name}{' '}
                                            {item.sex === 1 ? '先生' : '女士'}{' '}
                                            {item.phone}
                                    ...
                                    <View
                                        style={
                                            styles.content_item_center_address
                                        }>
                                        <Text
                                            style={
                                                styles.content_item_center_address_text
                                            }>
                                            {item.address}
                                        </Text>
                                    </View>
                                ...
                                <TouchableOpacity
                                    onPress={this.editAddressClick.bind(this)}
                                    style={styles.content_item_right}>
                                    <Image
                                        style={styles.content_item_img}
                                        source={require('../../img/home/edit.png')}
                                    />
                                </TouchableOpacity>
                            </View>
                        );
